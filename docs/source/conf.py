...
# -*- coding: utf-8 -*-
#
# pybabylonjs documentation build configuration file
#
...
_version_py = os.path.join(repo, "pybabylonjs", "_version.py")
version_ns = {}
...
htmlhelp_basename = "pybabylonjsdoc"
...
latex_documents = [
    (master_doc, "pybabylonjs.tex", "pybabylonjs Documentation", "TileDB", "manual"),
]
...
man_pages = [(master_doc, "pybabylonjs", "pybabylonjs Documentation", [author], 1)]
